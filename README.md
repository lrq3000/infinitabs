...
* [Floccus](https://github.com/floccusaddon/floccus): Autosync bookmarks (and hence sessions if using InfiniTabs) between browsers (also works on mobile via native Floccus app on F-Droid or [Mises](https://github.com/mises-id/mises-browser-core) or [Cromite](https://github.com/uazo/cromite/)). By using both floccus and infinitabs on desktop, and floccus on mobile, this allows to sync sessions unidirectionally (you can also do bidirectional syncing by manually saving all mobile tabs as bookmarks - but as of january 2026 this will lose mobile tabs groups due to a limitation in Android Chromium).
