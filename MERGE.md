...
In case a PR is in conflict with the latest `main` branch commits, here is the procedure that is advised to sync the PR branch to main (this can be applied to both human-made PRs and coding agents made PRs such as Jules'):
...
- Continuously synchronize: merge `origin/main` into your PR branch regularly
